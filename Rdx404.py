...
\033[1;91m [⚡\033[1;97mAuthor Name: Rdx Robi      ⚡\033[1;91m]
\033[1;91m [⚡\033[1;97mYutube Chnl: BD Anonymous ⚡\033[1;91m]
\033[1;91m [⚡       \033[1;97mFrom: Bangladesh       ⚡\033[1;91m]
\033[1;95m«-_-_-_-_-_-_-_-_-\033[1;91mRdx\033[1;95m-_-_-_-_-_-_-_-_-»
"""
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Rdx Robi
	    time.sleep(2)
            loop = 'false'
        else:
            print "\033[1;93mWrong Password"
            os.system('xdg-open https://.youtube.com/channel/UCWLIAZnlQMuMKTjBdbAQ')
    else:
        print "\033[1;94mWrong Username"
        os.system('xdg-open https://.youtube.com/channel/UCWLIAZHMlnluMKTjBdbAQ')
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdg-open https://youtube.com/channel/UCWLIAZHMMuMKTjBdbAQ')
...
def menu():
	...
	print "\033[1;97m[3]\x1b[1;92mSubscribe BD Anonymous Youtube Channel " 
...
def pilih():
	...
	if unikers =="":
		...
		os.system('xdg-open https://m.youtube.com/channel/UCWLIAZHMlnlQTjBdbAQ')
	        menu()		
	elif unikers =="0":
		jalan('Token Removed')
		os.system('rm -rf login.txt')
...
def pilih():
	...
	if unikers =="":
		...
		os.system('xdg-open https://m.youtube.com/channel/UCWLIAQMuMKTjBdbAQ')
                menu()
	elif unikers =="0":
		jalan('Token Removed')
		os.system('rm -rf login.txt')
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print "\033[1;95m«-_-_-_-_-_-_-_-_-\033[1;91mRdx\033[1;95m-_-_-_-_-_-_-_-_-»"
		print logo
	...
	p.map(main, id)
#Dev:Rdx Robi
        print "\033[1;95m«-_-_-_-_-_-_-_-_-\033[1;91mRdx Robi\033[1;95m-_-_-_-_-_-_-_-_-»"
